  ...
  return (
    <section id="home" className="min-h-screen relative overflow-hidden bg-primary-gradient">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[1200px] h-[1200px] rounded-full border border-sky-500/10 animate-[spin_60s_linear_infinite]" />
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] rounded-full border border-blue-500/10 animate-[spin_45s_linear_infinite_reverse]" />
        <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] rounded-full border border-indigo-500/10 animate-[spin_30s_linear_infinite]" />
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
              <a
                href="#contact"
                className="btn-primary text-white px-10 py-4 rounded-full font-bold text-lg shadow-2xl magnetic shine-on-hover"
              >
                Let's Connect
              </a>
              <a
                ...
                className="btn-secondary flex items-center gap-3 text-white px-10 py-4 rounded-full font-bold text-lg magnetic shine-on-hover"
              >
