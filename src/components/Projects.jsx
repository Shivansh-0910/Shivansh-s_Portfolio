  ...
  const projects = [
    {
      ...
      stats: { users: '1k+', performance: '99.7%', rating: 4.9 }
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={sectionRef}>
        ...
        <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-10">
          {projects.map((project, index) => (
            <div
              key={index}
              className={`group relative glass rounded-3xl overflow-hidden blue-border hover-lift card-3d card-accent shine-on-hover ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
