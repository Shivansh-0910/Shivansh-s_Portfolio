...
const Header = () => {
  ...
  return (
    <>
    <div className="fixed top-0 left-0 h-1 bg-gradient-to-r from-sky-400 to-blue-600" style={{ width: `${progress}%`, zIndex: 60 }} />
              ...
              return (
                <a
                  ...
                  className={`relative transition-all duration-300 font-medium group ${
                    isActive ? 'text-white' : 'text-slate-300 hover:text-sky-400'
                  }`}
                  style={{ animationDelay: `${index * 0.1}s` }}
                >
                  {item.name}
                  <span
                    className={`absolute -bottom-1 left-0 h-0.5 bg-gradient-to-r from-sky-400 to-blue-500 transition-all duration-300 ${
