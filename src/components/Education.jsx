      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={sectionRef}>
        ...
        <div className="space-y-12">
          {education.map((edu, index) => (
            <div
              key={index}
              className={`glass rounded-3xl p-8 blue-border hover-lift card-3d group card-accent shine-on-hover ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
              style={{ animationDelay: `${index * 0.3}s` }}
            >
            <div className="flex flex-col lg:flex-row lg:items-start gap-8 relative overflow-hidden">
