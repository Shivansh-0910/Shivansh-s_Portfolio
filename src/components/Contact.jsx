      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={sectionRef}>
        ...
        <div className="grid lg:grid-cols-2 gap-16">
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-500 ${
              ...
              <div className="space-y-6">
                {contactInfo.map((item, index) => (
                  <a
                    key={index}
                    href={item.link}
                    className="flex items-center gap-6 glass p-6 rounded-2xl blue-border hover-lift card-3d group card-accent shine-on-hover"
                  >
            ...
            <div className="glass p-6 rounded-2xl blue-border hover-lift card-accent">
          ...
          <div className="glass p-8 rounded-3xl blue-border hover-lift card-accent">
              <h3 className="text-3xl font-bold text-white mb-8">
