    ...
    <section id="about" className="py-32 bg-secondary-gradient relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={sectionRef}>
        <div className="text-center mb-20">
          <h2 className={`text-5xl sm:text-6xl font-black text-white mb-6 tracking-tight transition-all duration-1000 ${
          ...
          <div className={`mt-4 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100' : 'opacity-0'}`}>
            <span className="inline-block px-4 py-2 rounded-full bg-white/5 text-slate-300 text-sm blue-border">
          ...
          <div className={`transition-all duration-1000 delay-700 ${
            ...
            <div className="grid grid-cols-2 gap-6">
              {highlights.map((item, index) => (
                <div
                  key={index}
                  className={`relative glass p-6 rounded-2xl blue-border hover-lift card-3d group overflow-hidden card-accent shine-on-hover`}
                  style={{ animationDelay: item.delay }}
                >
                  <div className="absolute -right-6 -top-6 w-24 h-24 rounded-full bg-sky-500/10 blur-2xl" />
        ...
        <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 transition-all duration-1000 delay-1000 ${
          ...
          {[
            ...
            <div key={index} className="text-center glass p-6 rounded-2xl blue-border hover-lift relative overflow-hidden card-accent">
              <div className="absolute inset-0 opacity-5 bg-[radial-gradient(circle_at_30%_20%,#38bdf8,transparent),radial-gradient(circle_at_70%_80%,#6366f1,transparent)]" />
