      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10" ref={sectionRef}>
        ...
        <div className="grid lg:grid-cols-3 gap-8">
          {skillCategories.map((category, categoryIndex) => (
            <div
              key={categoryIndex}
              className={`relative glass p-8 rounded-3xl blue-border hover-lift card-3d overflow-hidden card-accent ${
                isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
              }`}
                    ...
                    <div key={skillIndex} className="space-y-3">
                      ...
                      <div className="relative">
                        <div className="w-full bg-slate-700/50 rounded-full h-3 overflow-hidden">
                          ...
                          >
                            <span className="absolute right-2 top-1/2 -translate-y-1/2 text-[10px] text-white/90">
